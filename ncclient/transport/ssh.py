                ...
                if not q.empty() and chan.send_ready():
                    ...
                    try:
                        ...
                        if 'urn:ietf:params:netconf:base:1.1' in self._client_capabilities:
                            if self._server_capabilities:
                                if 'urn:ietf:params:netconf:base:1.0' in self._server_capabilities or 'urn:ietf:params:xml:ns:netconf:base:1.0' in self._server_capabilities:
                                    # send using v1.0 EOM markers
                                    data = "%s%s"%(data, MSG_DELIM)
                                elif 'urn:ietf:params:netconf:base:1.1' in self._server_capabilities:
